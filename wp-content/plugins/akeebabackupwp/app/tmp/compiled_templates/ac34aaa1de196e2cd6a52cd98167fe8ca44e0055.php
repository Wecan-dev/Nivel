<?php /* /var/www/html/Nivel/wp-content/plugins/akeebabackupwp/app/Solo/ViewTemplates/Manage/comment.blade.php */ ?>
<?php
/**
 * @package   solo
...
<form name="adminForm" id="adminForm" action="<?php echo $this->container->router->route('index.php?view=manage'); ?>" method="post"
	...
	<div class="form-group">
		<label class="control-label col-sm-3" for="description">
			<?php echo \Awf\Text\Text::_('COM_AKEEBA_BUADMIN_LABEL_DESCRIPTION'); ?>
		</label>
		<div class="col-sm-9">
	...
	<div class="form-group">
		<label class="control-label col-sm-3" for="comment">
			<?php echo \Awf\Text\Text::_('COM_AKEEBA_BUADMIN_LABEL_COMMENT'); ?>
		</label>
		<div class="col-sm-9">
